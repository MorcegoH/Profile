    ...
    <div className="max-w-5xl mx-auto px-6">
      <div className="mb-10 flex items-center space-x-6">
        ...
        <div className="flex flex-col">
          <h3 className="text-xs md:text-xl font-bold tracking-[0.2em] text-purple-500 font-cinzel">III</h3>
          <div className="h-px w-full bg-gradient-to-r from-purple-500/50 to-transparent mt-1"></div>
          <p className="text-xl md:text-3xl font-serif italic text-white mt-1 tracking-tight opacity-80">Trajetória Profissional</p>
        </div>
      </div>

      <div className="divide-y divide-white/5">
        {experiences.map((exp, idx) => (
          <section key={idx} className="group grid md:grid-cols-12 gap-4 md:gap-8 py-10 md:py-16">
            {/* Left Column: Period */}
            ...
            <div className="md:col-span-9">
              ...
              <div className="mb-8">
                <p className="text-slate-300 font-light text-base md:text-lg leading-relaxed font-serif text-justify italic opacity-90">
                  {exp.description}
                </p>
              </div>
              ...
              <ul className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-4">
                {exp.achievements.map((ach, i) => (
                  <li key={i} className="flex items-start space-x-2 group/ach">
