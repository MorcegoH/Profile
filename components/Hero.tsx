  ...
  return (
    <div className="relative min-h-screen flex flex-col justify-center items-center overflow-hidden pt-10 md:pt-0">
      ...
      <div className="relative z-10 w-full max-w-[100vw] xl:max-w-7xl mx-auto px-0 md:px-4 flex flex-col items-center">
        ...
        {/* Content Container - Margens removidas para integração total */}
        <div className="relative w-full flex flex-col lg:flex-row items-center justify-center gap-0 lg:gap-12 transition-all duration-700">
          ...
          {/* Executive Portrait Area - Sem margens externas, apenas o quadro da foto */}
          <div className="relative group shrink-0 z-20">
            <div className="relative w-72 h-[450px] md:w-[400px] md:h-[600px] lg:w-[450px] lg:h-[700px] overflow-hidden rounded-sm border border-white/10 shadow-[0_0_100px_rgba(0,0,0,0.8)]">
              ...
              <img 
                ...
                alt="Heder Santos - Perfil Executivo"
          ...
          {/* Monumental Name Area - Encostado na imagem ou com respiro controlado pelo gap */}
          <div className="relative flex flex-col items-center lg:items-start text-center lg:text-left mt-8 lg:mt-0 z-10">
            ...
            {/* Subtitle - Alinhado sem caixas delimitadoras de margem */}
        ...
        {/* Scroll Indicator - Minimalista e afastado do conteúdo principal */}
